...
const SchedulesMusic = () => {
  ...
  const handleUpdateSchedule = async () => {
    ...
    try {
      ...
      await axios.put(`http://192.168.99.142:5000/schedules/${selectedSchedule.id}`, updatedSchedule, {
  ...
  const handleDelete = async (scheduleId) => {
    if (window.confirm('Are you sure you want to delete this schedule?')) {
      try {
        await axios.delete(`http://192.168.99.162:5000/schedules/${scheduleId}`);
